...
metrics_df.to_csv(f'{root}/training_metrics3.csv', index=False)
...
confusion_matrix_path = f'{root}/confusion_matrix3.png'
...
model_save_path = f'{root}/distilbert_finetuned3.pkl'
